...
# ============================
# Passo 1: Ler o CSV e preparar os dados
# ============================
...
# Corrigir nomes de colunas com espaços extras, se houver
...
# Remover linhas com numeração ausente
...
# ============================
# Passo 3A: Top5 por Marca (por mês)
# ============================
...
# ============================
# Passo 3B: Top5 por Mês (independente da marca)
# ============================
...
# ============================
# Passo 4: Relatório de numerações
# ============================
...
# ============================
# Passo 5: Classificação por gênero com percentuais relativos ao gênero
# ============================
...
# Separar por gênero e calcular percentuais dentro de cada um
...
# Resumo geral de Feminino e Masculino
...
# ============================
output_file = "Relatorio_Vendas_Numercoes.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')
workbook = writer.book

# --- Planilha: Relatorio_Final
